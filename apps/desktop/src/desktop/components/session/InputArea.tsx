        ...
        >
          ...
          {drop.files.length > 0 && (
            <div className="flex flex-wrap gap-1.5 px-3 pt-2.5 pb-1">
              {drop.files.map(f => (
                <div key={f.relPath} className="flex items-center gap-1 pl-1 pr-2 py-0.5 rounded-md bg-bg-hover border border-border text-text-secondary text-xs font-medium max-w-[220px]">
                  {f.previewUrl
