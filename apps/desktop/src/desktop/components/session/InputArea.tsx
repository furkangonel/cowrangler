        ...
        {!hideModelPicker ? (
          <div className="flex items-center justify-between mt-2 px-0.5">
            ...
            <div className="relative" ref={modelPickerRef}>
              ...
              {modelPickerOpen && (
                <div className="absolute bottom-full left-0 mb-1.5 z-50 bg-bg-secondary border border-border rounded-xl shadow-pop overflow-hidden animate-slide-up w-72">
