 ...
 * ({workdir}/.cowrangler/context/agents/<sessionId>). getProjectContextSkillsDir
 * ile aynı desen — session-scoped, başka session'lara sızmaz.
 */
...
/**
 * Session-scoped bellek dosyası
 * ({workdir}/.cowrangler/context/memory/<sessionId>.md).
 */
